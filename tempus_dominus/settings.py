...
TEMPUS_DOMINUS_DATE_FORMAT = getattr(settings, 'TEMPUS_DOMINUS_DATE_FORMAT', "yyyy-MM-dd")

TEMPUS_DOMINUS_DATETIME_FORMAT = getattr(settings, "TEMPUS_DOMINUS_DATETIME_FORMAT", "yyyy-MM-dd HH:mm:ss")
